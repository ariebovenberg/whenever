...
# from datetime import py_timedelta

import pytest

# from pytest import approx

from whenever import TimeDelta  # , hours, microseconds, minutes, seconds
...
#     assert TimeDelta.from_py_timedelta(py_timedelta(0)) == TimeDelta()
