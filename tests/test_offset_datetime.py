...
def test_init_optionality():
    assert (
        ...
        == OffsetDateTime(2020, 8, 15, 12, 0, 0, 0, hours(5))
    )
...
def test_init_named():
    ...
    assert d == OffsetDateTime(2020, 8, 15, 5, 12, 30, 0, hours(5))
...
class TestFromStr:
    ...
    def test_valid_three_fractions(self):
        assert OffsetDateTime.fromstr(
            ...
            2020, 8, 15, 12, 8, 30, 349_000, timedelta(hours=5, seconds=33)
        )
    ...
    def test_valid_six_fractions(self):
        assert OffsetDateTime.fromstr(
            ...
            30,
            349_123,
            timedelta(hours=5, seconds=33, microseconds=987_654),
        )
    ...
    def test_unpadded(self):
        with pytest.raises(ValueError):
            OffsetDateTime.fromstr("2020-8-15T12:8:30+05:00")

    def test_overly_precise_fraction(self):
        with pytest.raises(ValueError):
            OffsetDateTime.fromstr("2020-08-15T12:08:30.123456789123+05:00")

    def test_invalid_offset(self):
        with pytest.raises(ValueError, match="offset"):
            OffsetDateTime.fromstr("2020-08-15T12:08:30-99:00")

    def test_no_offset(self):
        with pytest.raises(ValueError):
            OffsetDateTime.fromstr("2020-08-15T12:08:30")

    def test_no_seconds(self):
        with pytest.raises(ValueError):
            OffsetDateTime.fromstr("2020-08-15T12:08-05:00")

    def test_empty(self):
        with pytest.raises(ValueError):
            OffsetDateTime.fromstr("")

    def test_garbage(self):
        with pytest.raises(ValueError):
            OffsetDateTime.fromstr("garbage")

    @given(text())
    def test_fuzzing(self, s: str):
        with pytest.raises(ValueError, match="Invalid"):
            OffsetDateTime.fromstr(s)
...
def test_equality():
    ...
    assert OffsetDateTime(
        2020, 8, 15, 12, 8, 30, 450, hours(3)
    ) != OffsetDateTime(2020, 8, 15, 12, 8, 31, 450, hours(3))
...
def test_fromtimestamp():
    assert OffsetDateTime.fromtimestamp(0, offset=hours(3)) == OffsetDateTime(
        1970, 1, 1, 3, offset=hours(3)
    )
    assert OffsetDateTime.fromtimestamp(
...
def test_repr():
    d = OffsetDateTime(
        2020, 8, 15, 23, 12, 9, 987_654, timedelta(hours=5, minutes=22)
    )
    assert (
...
def test_comparison():
    d = OffsetDateTime.fromstr("2020-08-15T15:12:09+05:00")
    later = OffsetDateTime.fromstr("2020-08-15T16:00:00+02:00")
    assert d < later
    assert d <= later
    assert later > d
    assert later >= d
...
def test_to_py():
    d = OffsetDateTime(2020, 8, 15, 23, 12, 9, 987_654, hours(5))
...
def test_from_py():
    ...
    assert OffsetDateTime.from_py(d) == OffsetDateTime(
        2020, 8, 15, 23, 12, 9, 987_654, hours(2)
    )
...
def test_min_max():
    assert OffsetDateTime.min == OffsetDateTime(
        1, 1, 1, offset=hours(24) - timedelta.resolution
    )
    assert OffsetDateTime.max == OffsetDateTime(
        ...
        59,
        999_999,
        offset=hours(-24) + timedelta.resolution,
    )
...
def test_subtract_datetime():
    d = OffsetDateTime(2020, 8, 15, 23, 12, 9, 987_654, hours(5))
    other = OffsetDateTime(2020, 8, 14, 23, 12, 4, 987_654, hours(-3))
    assert d - other == timedelta(hours=16, seconds=5)


def test_pickle():
    d = OffsetDateTime(2020, 8, 15, 23, 12, 9, 987_654, hours(3))
