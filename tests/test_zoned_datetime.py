...
class TestDayLength:
    ...
    def test_extreme_bounds(self):
        # lower bound is fine
        d_min = ZonedDateTime(1, 1, 1, tz="Etc/UTC")
        assert d_min.day_length() == hours(24)
        # TODO lower bound is NOT fine

        d_max = ZonedDateTime(9999, 12, 31, tz="Etc/UTC")

        with pytest.raises(ValueError, match="range"):
            d_max.day_length()

        # TODO system datetime
