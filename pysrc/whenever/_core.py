...
try:  # pragma: no cover
    ...
    from ._whenever import (
        ...
        _ignore_potentially_stale_offset_warning as _ignore_potentially_stale_offset_warning,
        _ignore_timezone_unaware_arithmetic_warning as _ignore_timezone_unaware_arithmetic_warning,
