...
@final
class Instant(_PyDateTimeMixin, _KnowsInstant):
    @classmethod
    def from_utc(
        cls,
        year: int,
...
@final
class OffsetDateTime(_PyDateTimeMixin, _KnowsInstantAndLocal):
    def __init__(
        self,
        year: int,
        month: int,
...
@final
class ZonedDateTime(_PyDateTimeMixin, _KnowsInstantAndLocal):
    def __init__(
        self,
        year: int,
        month: int,
...
@final
class SystemDateTime(_PyDateTimeMixin, _KnowsInstantAndLocal):
    def __init__(
        self,
        year: int,
        month: int,
...
@final
class LocalDateTime(_PyDateTimeMixin, _DateOrTimeMixin, _KnowsLocal):
    def __init__(
        self,
        year: int,
        month: int,
