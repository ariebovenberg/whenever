...
@final
class PlainDateTime(_PyDateTimeMixin, _LocalTime):
    @overload
    def __init__(self, iso_string: str, /) -> None: ...
    @overload
    def __init__(self, py_datetime: _datetime, /) -> None: ...
