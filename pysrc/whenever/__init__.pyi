...
class _ContainsLocalDateTime(_BasicConversions, ABC):
    @property
    def year(self) -> int: ...
    @property
    def month(self) -> int: ...
...
class _Aware(_BasicConversions, ABC):
    ...
    def __lt__(self, other: _Aware) -> bool: ...
    def __le__(self, other: _Aware) -> bool: ...
    def __gt__(self, other: _Aware) -> bool: ...
    def __ge__(self, other: _Aware) -> bool: ...
...
class Instant(_Aware):
    ...
    @overload
    def __sub__(self, other: _Aware) -> TimeDelta: ...
    @overload
...
@final
class LocalDateTime(_ContainsLocalDateTime):
    def __init__(
        self,
        year: int,
        month: int,
