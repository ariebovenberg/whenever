...
class TimeDelta(_DeltaMixin, _OrderMixin):
    ...
    @deprecated(
        "Use in_units(units=['hours', 'minutes', 'seconds', 'nanoseconds']) instead"
    )
...
class DateDeltaDict(TypedDict, total=False):
    years: int
    months: int
    weeks: int
    days: int
