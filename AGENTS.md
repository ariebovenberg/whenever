...
- `docs/glossary.md` — canonical user-facing vocabulary. Use the headwords in code, docs, messages, and test names; a word listed under *Preferred over* is a rejected synonym and never appears in any of them, including as an identifier fragment
