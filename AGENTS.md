...
- `docs/glossary.md` — canonical user-facing vocabulary. Use the headwords in code, docs, messages, and test names; a word listed under *Also called* is a rejected synonym and never appears in any of them, including as an identifier fragment. Public names borrowed from the stdlib and the ecosystem keep their spelling (`tz`, `tzpath`, `format`); the rule governs prose, messages, test names and new identifiers
