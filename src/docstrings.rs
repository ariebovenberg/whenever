...
";
pub(crate) const ADJUST_LOCAL_DATETIME_MSG: &CStr = c"deprecated: ignore_dst-era message";
...
pub(crate) const DIFF_LOCAL_MSG: &CStr = c"deprecated: ignore_dst-era message";
pub(crate) const DIFF_OPERATOR_LOCAL_MSG: &CStr = c"deprecated: ignore_dst-era message";
...
pub(crate) const SHIFT_LOCAL_MSG: &CStr = c"deprecated: ignore_dst-era message";
