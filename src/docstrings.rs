...
add($self, arg=..., /, relative_to=None, in_units=None, round_mode='trunc', round_increment=1, cal_unit_composition_ok=False, **kwargs)
--
...
";
pub(crate) const ITEMIZEDDATEDELTA_KEYS: &CStr = c"\
...
subtract($self, arg=..., /, relative_to=None, in_units=None, round_mode='trunc', round_increment=1, cal_unit_composition_ok=False, **kwargs)
--
...
";
pub(crate) const ITEMIZEDDELTA_KEYS: &CStr = c"\
