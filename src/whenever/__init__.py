...
class DateTime(ABC):
    ...
    if not TYPE_CHECKING and SPHINX_BUILD:  # pragma: no cover
        ...
        def replace(self: _T, /, **kwargs) -> _T:
            ...
            (e.g. ValueError for invalid values, or Ambiguous for ambiguous
            :class:`ZonedDateTime` values).
...
class AwareDateTime(DateTime):
    ...
    @abstractmethod
    def as_zoned(self, zone: str, /) -> ZonedDateTime:
        ...
        def __eq__(self, other: object) -> bool:
            ...
            .. code-block:: python
               ...
               OffsetDateTime(2020, 8, 15, hour=23, offset=hours(1)) == (
                   ZonedDateTime(2020, 8, 15, hour=18, zone="America/New_York")
               )
            """
    ...
    def __lt__(self, other: AwareDateTime) -> bool:
        ...
        .. code-block:: python
           ...
           OffsetDateTime(2020, 8, 15, hour=23, offset=hours(8)) < (
               ZoneDateTime(2020, 8, 15, hour=20, zone="Europe/Amsterdam")
           )
        """
...
class ZonedDateTime(AwareDateTime):
    ...
    - The ``zone`` argument is the timezone's name in the IANA database.
    ...
    def disambiguated(self) -> bool:
        ...
        .. code-block:: python
           ...
           ZonedDateTime(2020, 8, 15, 23, zone="Europe/London", disambiguate="later").is_ambiguous()
           # True: disambiguation needed, since 2:15 AM occurs twice
           ZonedDateTime(2023, 10, 29, 2, 15, zone="Europe/Amsterdam", disambiguate="later").is_ambiguous()
        """
