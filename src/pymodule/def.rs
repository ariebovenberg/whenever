...
struct InternedStrings {
    ...
    str_warn_stacklevel: Owned<PyObj>,
...
fn intern_strings() -> PyResult<InternedStrings> {
    Ok(InternedStrings {
        ...
        str_warn_stacklevel: intern(c"_warn_stacklevel")?,
        ...
        str_tz_id_display: intern(c"tz_id_display")?,
...
pub(crate) struct State {
    ...
    pub(crate) str_warn_stacklevel: Owned<PyObj>,
    ...
    pub(crate) str_tz_id_display: Owned<PyObj>,
