...
struct InternedStrings {
    ...
    str_overflow: Owned<PyObj>,
    str_wrap: Owned<PyObj>,
    str_cap: Owned<PyObj>,
    str_tz: Owned<PyObj>,
...
fn intern_strings() -> PyResult<InternedStrings> {
    Ok(InternedStrings {
        ...
        str_overflow: intern(c"overflow")?,
        str_wrap: intern(c"wrap")?,
        str_cap: intern(c"cap")?,
        str_tz: intern(c"tz")?,
...
pub(crate) struct State {
    ...
    pub(crate) str_overflow: Owned<PyObj>,
    pub(crate) str_wrap: Owned<PyObj>,
    pub(crate) str_cap: Owned<PyObj>,
