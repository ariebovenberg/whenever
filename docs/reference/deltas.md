...
That makes the operation explicit, but it can change the meaning of later
application to a datetime. The operation emits
...
or if you need reference-aware composition via `relative_to`.
